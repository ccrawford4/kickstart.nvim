...
-- Show line numbers and set relative line numbers
vim.o.number = true
...
vim.keymap.set('n', '<leader>cd', vim.diagnostic.open_float, { desc = 'Show diagnostic at [C]ursor' })

-- Buffer navigation keymaps
vim.keymap.set('n', '<Tab>', '<cmd>bnext<CR>', { desc = 'Next buffer' })
vim.keymap.set('n', '<leader><Tab>', '<cmd>bprev<CR>', { desc = 'Previous buffer' })
vim.keymap.set('n', '<leader>bd', '<cmd>bp | bd #<CR>', { desc = '[B]uffer [D]elete' })
vim.keymap.set('n', '<leader>bx', '<cmd>%bd | e# | bd#<CR>', { desc = '[B]uffer e[X]clude others' })
